...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'realmate_challenge.chat.apps.ChatConfig', 
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'realmate_challenge' / 'chat' / 'templates' ], 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'realmate_challenge' / 'chat' / 'static', # This directory should exist
]
